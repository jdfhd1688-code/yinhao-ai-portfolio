...
const ui = {
  zh: {
    ...
    workLabel: "01 / 作品", workTitle: <>沿途的<br /><em>几个停靠点。</em></>, featured: "正在路上的作品", featuredNote: "我正在走向的 AI 产品与智能体方向。",
  ...
  en: {
    ...
    workLabel: "01 / SELECTED WORK", workTitle: <>Stops along<br /><em>the road.</em></>, featured: "FEATURED WORK", featuredNote: "The AI product and agent direction I am moving toward.",
