...
export const projects: Project[] = [
  ...
  },
  {
    ...
    workflow: { zh: ["合同上传", "材料解析 / 切分", "合同条款检索", "法规检索", "风险判断", "人工复核", "结构化报告"], en: ["Contract upload", "Document parsing / chunking", "Contract clause retrieval", "Legal retrieval", "Risk assessment", "Human review", "Structured report"] },
    ...
    role: { zh: ["将合同审查拆解为明确的多步骤 Workflow，避免 LLM 直接自由生成结论。", "设计合同条款与法律法规的双层 RAG 检索逻辑，让风险判断同时连接合同语境与法律依据。", "将法规现行状态、适用范围与生效时间纳入检索与判断，降低引用失效或不适用条文的风险。", "设计风险分级与 Human-in-the-loop 分支，高风险或依据不足时进入人工复核。", "定义结构化 JSON 与报告输出，方便后续复核与系统集成。"], en: ["Broke contract review into an explicit multi-step workflow so the LLM does not freely generate conclusions.", "Designed two-layer RAG retrieval across contract clauses and legal sources, connecting risk assessment to both contract context and legal grounds.", "Included legal status, scope and effective dates in retrieval and reasoning to reduce reliance on expired or inapplicable provisions.", "Designed risk tiers and a human-in-the-loop branch so high-risk or insufficient-evidence results move to legal review.", "Defined structured JSON and report outputs for review and downstream system integration."] },
    features: { zh: ["法规必须确认现行状态、适用范围与生效时间，避免引用失效或不适用条文。", "高风险结果进入人工法务复核，不让模型直接完成最终法律判断。", "依据不足时明确输出“依据不足，需要人工复核”，而不是编造法条。"], en: ["Legal sources must be checked for current status, scope and effective dates before use.", "High-risk results move to human legal review; the model does not make the final legal judgment.", "When evidence is insufficient, the system says so and requests human review instead of inventing legal grounds."] },
    ...
    externalLinks: [
      { label: { zh: "查看 Prototype", en: "Open Prototype" }, href: "https://enterprise-legal-ai-agent.onrender.com/" },
      { label: { zh: "查看 GitHub", en: "View GitHub" }, href: "https://github.com/jdfhd1688-code/enterprise-legal-ai-agent" },
    ],
  ...
  },
  {
    ...
    title: { zh: "AI 法律文书协作与案件管理", en: "AI Legal Document Collaboration & Case Workflow" }, subtitle: { zh: "真实律所场景下的 Workflow 与 Human-in-the-loop 实践", en: "Real law-firm workflow and human-in-the-loop practice" },
    ...
    statusLabel: { zh: "真实 Workflow 案例", en: "Real Workflow Case Study" },
    cardTag: { zh: "查看案例 ↗", en: "View Case Study ↗" },
    externalLinks: [
      { label: { zh: "查看完整案例 PDF", en: "View Full Case Study PDF" }, href: "/reports/legal-ai-workflow-case-study.pdf" },
    ],
  ...
  },
  {
    ...
    title: { zh: "AI 短剧 / AI 剧本工具市场测评", en: "AI Short Drama / AI Script Tool Research" }, subtitle: { zh: "从模型能力比较到多模型编剧 Workflow", en: "From model comparison to multi-model screenwriting workflow" },
    ...
    plannedAssets: [], availableAssets: [],
    statusLabel: { zh: "研究案例", en: "Research Case Study" },
    cardTag: { zh: "查看研究 ↗", en: "View Research ↗" },
    externalLinks: [
      { label: { zh: "查看完整研究 PDF", en: "View Full Research PDF" }, href: "/reports/ai-script-tool-research-2026.pdf" },
    ],
  ...
  },
  {
    ...
    title: { zh: "小说 IP 改编与短剧编剧", en: "IP Adaptation & Short Drama Screenwriting" }, subtitle: { zh: "从小说 IP 到正式发行短剧", en: "From Novel IP to Released Motion Comic" },
    ...
    ctaLabel: { zh: "查看作品", en: "View Project" }, ctaHref: "/work/short-drama",
  },
  {
